 ...
 * @LastEditTime: 2023-01-25 17:21:21
...
u8 wireless_offline_cnt=0, wireless_offline_flag=0;

void OLED_Receive_Refresh(void)
{
	
	  //Plane Battery Refresh
    if(wireless_offline_flag)
    {
        OLED_ShowString(0, 2, "2.4G OFFLINE", 16);
		return;
    }
    else
    {
